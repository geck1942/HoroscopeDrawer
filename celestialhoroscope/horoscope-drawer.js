  ...
  _createClass(Drawer, [{
    ...
    value: function drawZodiacDegrees() {
      ...
      for (var degree = 0; degree < 360; degree++) {
        ...
        var point1 = _calc.Calc.getPointOnCircle(this.radius.zodiac_inner, degree);
        var point2 = _calc.Calc.getPointOnCircle(degree % 10 == 0 ? this.radius.zodiac_innertick10 : degree % 5 == 0 ? this.radius.zodiac_innertick5 : this.radius.zodiac_innertick, degree);
    ...
    value: function drawZodiacSigns(startSign, signDegree) {
      var zodiacSignImageWidth = 6;
      var zodiacSignImageHeight = 6;
      ...
      for (var sign = 0; sign <= 11; sign++) {
        ...
        var topLeftPoint = _calc.Calc.getPointOnCircle(this.radius.zodiac_outer, degree);
        var topRightPoint = _calc.Calc.getPointOnCircle(this.radius.zodiac_inner, degree);
        var rightArcDescription = this.describeArc(this.radius.zodiac_inner, degreeNextSign, degree);
        var bottomLeftPoint = _calc.Calc.getPointOnCircle(this.radius.zodiac_outer, degreeNextSign);
        var leftArcDescription = this.describeArc(this.radius.zodiac_outer, degreeNextSign, degree);
        ...
        var zodiacSignPosition = _calc.Calc.getPointOnCircle(this.radius.zodiac_center, degreeBetweenSigns);
    ...
    value: function drawHouses() {
      ...
      var asc_point = _calc.Calc.getPointOnCircle(this.radius.houses_outer, 0);
    ...
    key: "drawHousesCircles",
    value: function drawHousesCircles() {
      if (!this.houses.hasHouses) return null;
      var circles = {
    ...
    key: "drawHousesNumbers",
    value: function drawHousesNumbers() {
      if (!this.houses.hasHouses) return null;
      var numbers = [this.drawHouseNumber("I", 0), this.drawHouseNumber("II", 1), this.drawHouseNumber("III", 2), this.drawHouseNumber("IV", 3), this.drawHouseNumber("V", 4), this.drawHouseNumber("VI", 5), this.drawHouseNumber("VII", 6), this.drawHouseNumber("VIII", 7), this.drawHouseNumber("IX", 8), this.drawHouseNumber("X", 9), this.drawHouseNumber("XI", 10), this.drawHouseNumber("XII", 11)];
      return numbers;
    }
  }, {
    key: "drawHouseNumber",
    value: function drawHouseNumber(text, index) {
      ...
      var point = _calc.Calc.getPointOnCircle(this.radius.houses_center, degree, 0);
    ...
    key: "drawHouseAxis",
    value: function drawHouseAxis(className, index) {
      var axeDegree = properties.houses.axes[index];
      var points = [_calc.Calc.getPointOnCircle(this.radius.houses_outertick, axeDegree), _calc.Calc.getPointOnCircle(this.radius.houses_inner, axeDegree, 0), _calc.Calc.getPointOnCircle(this.radius.houses_outertick, axeDegree - 1), _calc.Calc.getPointOnCircle(this.radius.houses_outertick, axeDegree + 1)];
      ...
      if (className) line.addClass(className);
      return line;
    }
  }, {
    key: "drawPlanet",
    value: function drawPlanet(planet, degree) {
      ...
      var linePoint1 = _calc.Calc.getPointOnCircle(this.radius.zodiac_inner, degree);
      var linePoint2 = _calc.Calc.getPointOnCircle(this.radius.planets, degree);
      ...
      var planetBackgroundPosition = _calc.Calc.getPointOnCircle(this.radius.planets, degree);
    ...
    value: function correctCollidingPlanets(planets) {
      planets = planets.sort(function (a, b) {
        return a.meta.degree > b.meta.degree ? 1 : a.meta.degree < b.meta.degree ? -1 : 0;
      });
      ...
      for (var planetIndex = 0; planetIndex < planets.length; planetIndex++) {
        ...
        while (planets[previousPlanetIndex] == null && previousPlanetIndex != planetIndex) {
          previousPlanetIndex--;
          if (previousPlanetIndex < 0) previousPlanetIndex = planets.length - 1;
        }
        if (planet == null || previousPlanetIndex == planetIndex) continue;
        ...
        while (this.planetsDoCollide(previousPlanet, planet, offset) && offset < this.MAX_PLANET_COLLISION_CORRECTION) {
          offset += 3;
        }var newPlanetPosition = _calc.Calc.getPointOnCircle(this.radius.planets - offset, planet.meta.degree);
    ...
    value: function planetsDoCollide(previousPlanet, planet, tryWithOffset) {
      //console.log("comparing " + currentPlanetDegree + " & " + nextPlanetDegree);
      var xy2 = _calc.Calc.getPointOnCircle(this.radius.planets - tryWithOffset, planet.meta.degree);
...
var Planets = function Planets() {
  ...
  var pngImagePath = "./resources/celestialchapters/planets/";
